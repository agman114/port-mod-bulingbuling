...
local _raw_actionhandlers = {
    --(ACTIONS.GOHOME and ActionHandler(ACTIONS.GOHOME, "taunt")),     
    (ACTIONS.LAVASPIT and ActionHandler(ACTIONS.LAVASPIT, "spit")),
    (ACTIONS.PICKUP and ActionHandler(ACTIONS.PICKUP, "eat")),
}
    ...
    State{
            ...
            onenter = function(inst) 
                ...
                if should_softstop then
                    if inst.fire_build then
                        inst.AnimState:PushAnimation("walk_angry", false)
                    else
                        inst.AnimState:PushAnimation("walk", false)
                    end
                else
                    if inst.fire_build then
                        inst.AnimState:PlayAnimation("walk_angry")
...
return StateGraph("dragonfly_follower", states, events, "idle", actionhandlers)