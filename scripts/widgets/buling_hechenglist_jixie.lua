...
self:QK()
	...
	--Обычная Лодка
	self.item_boat1 = self.image:AddChild(ImageButton("images/inventoryimages.xml", "rowboat.tex"))
	self.item_boat1:SetPosition(-120, 30, 0)
	self.item_boat1:SetOnClick(
	function ()
		SendModRPCToServer(MOD_RPC["bulingbuling"]["craft_item_free"], "buling_boat_item")
		self:QK()
		self.tubiao = self.image2:AddChild(Image("images/inventoryimages.xml", "rowboat.tex"))
		self.tubiao:SetPosition(-100, 100, 0)
		self.text1 = self.image2:AddChild(Text(BODYTEXTFONT, 60, "Buling Boat / Лодка"))
		self.text1:SetPosition(50, 100, 0)
		self.text2 = self.image2:AddChild(Text(BODYTEXTFONT, 30, "Wooden Rowboat for sea travel"))
		self.text2:SetPosition(80, -50, 0)
		...
		self.cailiao4 = self.gezi4:AddChild(ImageButton("images/inventoryimages.xml", "rope.tex"))
		self.cailiao5 = self.gezi5:AddChild(ImageButton("images/inventoryimages.xml", "boards.tex"))
		self.cailiao6 = self.gezi6:AddChild(ImageButton("images/inventoryimages.xml", "rope.tex"))
	...
	--Бронированная Лодка
	self.item_boat2 = self.image:AddChild(ImageButton("images/inventoryimages.xml", "rowboat.tex"))
	self.item_boat2:SetPosition(-40, 30, 0)
	self.item_boat2:SetOnClick(
	function ()
		SendModRPCToServer(MOD_RPC["bulingbuling"]["craft_item_free"], "bulingboat_tiexue_item")
		self:QK()
		self.tubiao = self.image2:AddChild(Image("images/inventoryimages.xml", "rowboat.tex"))
		self.tubiao:SetPosition(-100, 100, 0)
		self.text1 = self.image2:AddChild(Text(BODYTEXTFONT, 50, "Armored Boat / Бронелодка"))
		self.text1:SetPosition(50, 100, 0)
		self.text2 = self.image2:AddChild(Text(BODYTEXTFONT, 30, "Fast Armored Boat"))
		self.text2:SetPosition(80, -50, 0)
		...
		self.cailiao4 = self.gezi4:AddChild(ImageButton("images/inventoryimages/buling_puleidi.xml", "buling_puleidi.tex"))
		self.cailiao5 = self.gezi5:AddChild(ImageButton("images/inventoryimages.xml", "rowboat.tex"))
		self.cailiao6 = self.gezi6:AddChild(ImageButton("images/inventoryimages/buling_puleidi.xml", "buling_puleidi.tex"))
		self.cailiao7 = self.gezi7:AddChild(ImageButton("images/inventoryimages.xml", "gears.tex"))
		...
		--Обычная Лодка
	self.item_boat1 = self.image:AddChild(ImageButton("images/inventoryimages.xml", "rowboat.tex"))
	self.item_boat1:SetPosition(120, 110, 0)
	self.item_boat1:SetOnClick(
	function ()
		SendModRPCToServer(MOD_RPC["bulingbuling"]["craft_item_free"], "buling_boat_item")
		self:QK()
	...
	--Бронированная Лодка
	self.item_boat2 = self.image:AddChild(ImageButton("images/inventoryimages.xml", "rowboat.tex"))
	self.item_boat2:SetPosition(200, 110, 0)
	self.item_boat2:SetOnClick(
	function ()
		SendModRPCToServer(MOD_RPC["bulingbuling"]["craft_item_free"], "bulingboat_tiexue_item")
		self:QK()
		...
		self.cailiao3 = self.gezi3:AddChild(ImageButton("images/inventoryimages/buling_puleidi.xml", "buling_puleidi.tex"))
		self.cailiao4 = self.gezi4:AddChild(ImageButton("images/inventoryimages/buling_puleidi.xml", "buling_puleidi.tex"))
		self.cailiao5 = self.gezi5:AddChild(ImageButton("images/inventoryimages/buling_car_log.xml", "buling_car_log.tex"))
		self.cailiao6 = self.gezi6:AddChild(ImageButton("images/inventoryimages/buling_puleidi.xml", "buling_puleidi.tex"))
		self.cailiao7 = self.gezi7:AddChild(ImageButton("images/inventoryimages.xml", "gears.tex"))
		self.cailiao8 = self.gezi8:AddChild(ImageButton("images/inventoryimages/buling_puleidi.xml", "buling_puleidi.tex"))
		self.cailiao9 = self.gezi9:AddChild(ImageButton("images/inventoryimages.xml", "gears.tex"))
	...
	function ()
		...
		SendModRPCToServer(MOD_RPC["bulingbuling"]["craft_item_free"], "buling_car_log_item")
self:QK()
...
self:QK()
	...
	--电线杆
	self.item11 = self.image:AddChild(ImageButton("images/inventoryimages/buling_dianxiangan.xml", "buling_dianxiangan.tex"))
	self.item11:SetPosition(40, 30, 0)
	self.item11:SetOnClick(
	function ()

		SendModRPCToServer(MOD_RPC["bulingbuling"]["craft_item_free"], "buling_dianxiangan")
self:QK()
		self.tubiao = self.image2:AddChild(Image("images/inventoryimages/buling_dianxiangan.xml", "buling_dianxiangan.tex"))
		self.tubiao:SetPosition(-100, 100, 0)
		
		self.text1 = self.image2:AddChild(Text(BODYTEXTFONT, 60,STRINGS.NAMES.BULING_DIANXIANGAN))
		self.text1:SetPosition(50, 100, 0)
		
		self.text2 = self.image2:AddChild(Text(BODYTEXTFONT, 30,STRINGS.CHARACTERS.GENERIC.DESCRIBE.BULING_DIANXIANGAN))
		self.text2:SetPosition(80, -50, 0)
...
self:QK()
		...
		self.text1 = self.image2:AddChild(Text(BODYTEXTFONT, 60,STRINGS.NAMES.BULING_REPAIR_BOX))
		self.text1:SetPosition(50, 100, 0)
		
		self.text2 = self.image2:AddChild(Text(BODYTEXTFONT, 30,STRINGS.CHARACTERS.GENERIC.DESCRIBE.BULING_REPAIR_BOX))
		self.text2:SetPosition(80, -50, 0)
			
		self.cailiao1 = self.gezi1:AddChild(ImageButton("images/inventoryimages/buling_glass.xml", "buling_glass.tex"))
		self.cailiao2 = self.gezi2:AddChild(ImageButton("images/inventoryimages/buling_glass.xml", "buling_glass.tex"))
		self.cailiao3 = self.gezi3:AddChild(ImageButton("images/inventoryimages/buling_glass.xml", "buling_glass.tex"))
		self.cailiao5 = self.gezi5:AddChild(ImageButton("images/inventoryimages/buling_paotai.xml", "buling_paotai.tex"))
		self.cailiao7 = self.gezi7:AddChild(ImageButton("images/inventoryimages/buling_glass.xml", "buling_glass.tex"))
		self.cailiao8 = self.gezi8:AddChild(ImageButton("images/inventoryimages/buling_glass.xml", "buling_glass.tex"))
		self.cailiao9 = self.gezi9:AddChild(ImageButton("images/inventoryimages/buling_glass.xml", "buling_glass.tex"))
	end)
	----粉碎机
	self.item13 = self.image:AddChild(ImageButton("images/inventoryimages/buling_fensui.xml", "buling_fensui.tex"))
	self.item13:SetPosition(-120, -50, 0)
	self.item13:SetOnClick(
	function ()

		SendModRPCToServer(MOD_RPC["bulingbuling"]["craft_item_free"], "buling_fensui")
self:QK()
		self.tubiao = self.image2:AddChild(Image("images/inventoryimages/buling_fensui.xml", "buling_fensui.tex"))
		self.tubiao:SetPosition(-100, 100, 0)
		
		self.text1 = self.image2:AddChild(Text(BODYTEXTFONT, 60,STRINGS.NAMES.BULING_FENSUI))
		self.text1:SetPosition(50, 100, 0)
		
		self.text2 = self.image2:AddChild(Text(BODYTEXTFONT, 30,STRINGS.CHARACTERS.GENERIC.DESCRIBE.BULING_FENSUI))
		self.text2:SetPosition(80, -50, 0)
	...
	----未完成
	self.item14 = self.image:AddChild(ImageButton("images/inventoryimages/buling_dianxiangan.xml", "nil.tex"))--未完成
...
self:QK()
	...
	--铔金剪刀
	self.item17 = self.image:AddChild(ImageButton("images/inventoryimages/buling_yajingjian.xml", "buling_yajingjian.tex"))
...
self:QK()
	...
	--铔金斧
	self.item18 = self.image:AddChild(ImageButton("images/inventoryimages/buling_yajingfu.xml", "buling_yajingfu.tex"))
...
self:QK()
	...
	--铔金镐
	self.item19 = self.image:AddChild(ImageButton("images/inventoryimages/buling_yajinggao.xml", "buling_yajinggao.tex"))
...
function buling_hechenglist:page3()
	--传送带
	self.item1 = self.image:AddChild(ImageButton("images/inventoryimages/buling_chuansongdai_item.xml", "buling_chuansongdai_item.tex"))
	self.item1:SetPosition(-120, 190, 0)
	self.item1:SetOnClick(
	function ()

		SendModRPCToServer(MOD_RPC["bulingbuling"]["craft_item_free"], "buling_chuansongdai_item")
self:QK()
		self.tubiao = self.image2:AddChild(Image("images/inventoryimages/buling_chuansongdai_item.xml", "buling_chuansongdai_item.tex"))
		self.tubiao:SetPosition(-100, 100, 0)
		self.text1 = self.image2:AddChild(Text(BODYTEXTFONT, 60,STRINGS.NAMES.BULING_CHUANSONGDAI))
		self.text1:SetPosition(50, 100, 0)
		self.text2 = self.image2:AddChild(Text(BODYTEXTFONT, 30,STRINGS.CHARACTERS.GENERIC.DESCRIBE.BULING_CHUANSONGDAI))
		self.text2:SetPosition(80, -50, 0)
	...
	--机械臂
	self.item2 = self.image:AddChild(ImageButton("images/inventoryimages/buling_jixiebi_item.xml", "buling_jixiebi_item.tex"))
	self.item2:SetPosition(-40, 190, 0)
	self.item2:SetOnClick(
	function ()

		SendModRPCToServer(MOD_RPC["bulingbuling"]["craft_item_free"], "buling_jixiebi_item")
self:QK()
		self.tubiao = self.image2:AddChild(Image("images/inventoryimages/buling_jixiebi_item.xml", "buling_jixiebi_item.tex"))
		self.tubiao:SetPosition(-100, 100, 0)
		
		self.text1 = self.image2:AddChild(Text(BODYTEXTFONT, 60,STRINGS.NAMES.BULING_JIXIEBI))
		self.text1:SetPosition(50, 100, 0)
		
		self.text2 = self.image2:AddChild(Text(BODYTEXTFONT, 30,STRINGS.CHARACTERS.GENERIC.DESCRIBE.BULING_JIXIEBI))
		self.text2:SetPosition(80, -50, 0)
			
		self.cailiao2 = self.gezi2:AddChild(ImageButton("images/inventoryimages/buling_banshou.xml", "buling_banshou.tex"))
		self.cailiao5 = self.gezi5:AddChild(ImageButton("images/inventoryimages/buling_chuansongdai_item.xml", "buling_chuansongdai_item.tex"))
	end)
	--土培箱
	self.item3 = self.image:AddChild(ImageButton("images/inventoryimages/buling_shuipei_item.xml", "buling_shuipei_item.tex"))
	self.item3:SetPosition(40, 190, 0)
	self.item3:SetOnClick(
	function ()

		SendModRPCToServer(MOD_RPC["bulingbuling"]["craft_item_free"], "buling_shuipei_item")
self:QK()
		self.tubiao = self.image2:AddChild(Image("images/inventoryimages/buling_shuipei_item.xml", "buling_shuipei_item.tex"))
		self.tubiao:SetPosition(-100, 100, 0)
		
		self.text1 = self.image2:AddChild(Text(BODYTEXTFONT, 60,STRINGS.NAMES.BULING_SHUIPEI))
		self.text1:SetPosition(50, 100, 0)
		
		self.text2 = self.image2:AddChild(Text(BODYTEXTFONT, 30,STRINGS.CHARACTERS.GENERIC.DESCRIBE.BULING_SHUIPEI))
		self.text2:SetPosition(80, -50, 0)
			
		self.cailiao2 = self.gezi2:AddChild(ImageButton("images/inventoryimages.xml", "fertilizer.tex"))
		self.cailiao5 = self.gezi5:AddChild(ImageButton("images/inventoryimages/buling_chuansongdai_item.xml", "buling_chuansongdai_item.tex"))
	end)
	--物流箱
	self.item4 = self.image:AddChild(ImageButton("images/inventoryimages/buling_chest_mini_item.xml", "buling_chest_mini_item.tex"))
	self.item4:SetPosition(120, 190, 0)
	self.item4:SetOnClick(
	function ()

		SendModRPCToServer(MOD_RPC["bulingbuling"]["craft_item_free"], "buling_chest_mini_item")
self:QK()
		self.tubiao = self.image2:AddChild(Image("images/inventoryimages/buling_chest_mini_item.xml", "buling_chest_mini_item.tex"))
		self.tubiao:SetPosition(-100, 100, 0)
		
		self.text1 = self.image2:AddChild(Text(BODYTEXTFONT, 60,STRINGS.NAMES.BULING_CHEST_MINI))
		self.text1:SetPosition(50, 100, 0)
		
		self.text2 = self.image2:AddChild(Text(BODYTEXTFONT, 30,STRINGS.CHARACTERS.GENERIC.DESCRIBE.BULING_CHEST_MINI))
		self.text2:SetPosition(80, -50, 0)
			
		self.cailiao2 = self.gezi2:AddChild(ImageButton("images/inventoryimages/buling_chest.xml", "buling_chest.tex"))
		self.cailiao5 = self.gezi5:AddChild(ImageButton("images/inventoryimages/buling_chuansongdai_item.xml", "buling_chuansongdai_item.tex"))
	end)
	--自动合成
	self.item5 = self.image:AddChild(ImageButton("images/inventoryimages/buling_zidonghecheng_item.xml", "buling_zidonghecheng_item.tex"))
	self.item5:SetPosition(-120, 110, 0)
	self.item5:SetOnClick(
	function ()

		SendModRPCToServer(MOD_RPC["bulingbuling"]["craft_item_free"], "buling_zidonghecheng_item")
self:QK()
		self.tubiao = self.image2:AddChild(Image("images/inventoryimages/buling_zidonghecheng_item.xml", "buling_zidonghecheng_item.tex"))
		self.tubiao:SetPosition(-100, 100, 0)
		
		self.text1 = self.image2:AddChild(Text(BODYTEXTFONT, 60,STRINGS.NAMES.BULING_ZIDONGHECHENG))
		self.text1:SetPosition(50, 100, 0)
		
		self.text2 = self.image2:AddChild(Text(BODYTEXTFONT, 25,STRINGS.CHARACTERS.GENERIC.DESCRIBE.BULING_ZIDONGHECHENG))
		self.text2:SetPosition(80, -50, 0)
			
		self.cailiao2 = self.gezi2:AddChild(ImageButton("images/inventoryimages/buling_seedchest.xml", "buling_seedchest.tex"))
		self.cailiao5 = self.gezi5:AddChild(ImageButton("images/inventoryimages/buling_chuansongdai_item.xml", "buling_chuansongdai_item.tex"))
	end)
	--自动萃取
	self.item6 = self.image:AddChild(ImageButton("images/inventoryimages/buling_ronglu2.xml", "buling_ronglu2.tex"))
	self.item6:SetPosition(-40, 110, 0)
	self.item6:SetOnClick(
	function ()

		SendModRPCToServer(MOD_RPC["bulingbuling"]["craft_item_free"], "buling_ronglu2")
self:QK()
		self.tubiao = self.image2:AddChild(Image("images/inventoryimages/buling_ronglu2.xml", "buling_ronglu2.tex"))
		self.tubiao:SetPosition(-100, 100, 0)
		
		self.text1 = self.image2:AddChild(Text(BODYTEXTFONT, 60,STRINGS.NAMES.BULING_RONGLU2))
		self.text1:SetPosition(50, 100, 0)
		
		self.text2 = self.image2:AddChild(Text(BODYTEXTFONT, 30,STRINGS.CHARACTERS.GENERIC.DESCRIBE.BULING_RONGLU2))
		self.text2:SetPosition(80, -50, 0)
			
		self.cailiao2 = self.gezi2:AddChild(ImageButton("images/inventoryimages/buling_ronglu.xml", "buling_ronglu.tex"))
		self.cailiao5 = self.gezi5:AddChild(ImageButton("images/inventoryimages/buling_zhongjiqi_gaoya.xml", "buling_zhongjiqi_gaoya.tex"))
		self.cailiao8 = self.gezi8:AddChild(ImageButton("images/inventoryimages/buling_chuansongdai_item.xml", "buling_chuansongdai_item.tex"))
	end)
		--Обычная Лодка
	self.item_boat1 = self.image:AddChild(ImageButton("images/inventoryimages/buling_car_log.xml", "buling_car_log.tex"))
	self.item_boat1:SetPosition(120, 110, 0)
	self.item_boat1:SetOnClick(
	function ()
		SendModRPCToServer(MOD_RPC["bulingbuling"]["craft_item_free"], "buling_boat_item")
	...
	--Бронированная Лодка
	self.item_boat2 = self.image:AddChild(ImageButton("images/inventoryimages/buling_car_log.xml", "buling_car_log.tex"))
	self.item_boat2:SetPosition(200, 110, 0)
	self.item_boat2:SetOnClick(
	function ()
		SendModRPCToServer(MOD_RPC["bulingbuling"]["craft_item_free"], "bulingboat_tiexue_item")
	...
	--木制车车
	self.item7 = self.image:AddChild(ImageButton("images/inventoryimages/buling_car_log.xml", "nil.tex"))--未完成
	self.item7:SetPosition(40, 110, 0)
	self.item7:SetOnClick(
	function ()
...
self:QK()
	...
	--物质转换器
	self.item8 = self.image:AddChild(ImageButton("images/inventoryimages/buling_conversion.xml", "nil.tex"))--未完成
	self.item8:SetPosition(120, 110, 0)
	self.item8:SetOnClick(
	function ()
...
self:QK()
	...
	--次元存储箱
	self.item9 = self.image:AddChild(ImageButton("images/inventoryimages/buling_infinitebox.xml", "nil.tex"))--未完成
	self.item9:SetPosition(-120, 30, 0)
	self.item9:SetOnClick(
	function ()
...
self:QK()
	...
	--存储芯片
	self.item10 = self.image:AddChild(ImageButton("images/inventoryimages/buling_chipbox.xml", "nil.tex"))--未完成
	self.item10:SetPosition(-40, 30, 0)
	self.item10:SetOnClick(
	function ()
...
self:QK()
	...
	--铔金镐
	self.item11 = self.image:AddChild(ImageButton("images/inventoryimages/buling_yajinggao.xml", "nil.tex"))--未完成
	self.item11:SetPosition(40, 30, 0)
	self.item11:SetOnClick(
	function ()
...
self:QK()
	...
	--铔金斧
	self.item12 = self.image:AddChild(ImageButton("images/inventoryimages/buling_yajingfu.xml", "nil.tex"))--未完成
	self.item12:SetPosition(120, 30, 0)
	self.item12:SetOnClick(
	function ()
...
self:QK()
	...
	--铔金剪刀
	self.item13 = self.image:AddChild(ImageButton("images/inventoryimages/buling_yajingjian.xml", "nil.tex"))--未完成
	self.item13:SetPosition(-120, -50, 0)
	self.item13:SetOnClick(
	function ()
